...
public class SubjectEnrollmentController
    ...
    public ResponseEntity<List<SubjectEnrollmentDTO>> getBySubjectId(@PathVariable Long id) {
    ...
    public ResponseEntity<List<Long>> getStudentIdsBySubjectId(@PathVariable Long id) {
