...
@Repository
public interface FillInBlankQuestionRepository extends BaseRepository<FillInBlankQuestion, Long> {
    @Override
    @Query(
    ...
    Page<FillInBlankQuestion> findContaining(Pageable pageable, String search);
}
