...
export class SettingComponent {
  ...
  isLoading = true;
  showContent = false;
  selectedTab = 'editProfile'; // Set the default selected tab
  tabTitle = 'Edit Profile';
  subTitle = 'Set Up Your Personal Information';
  listItemClass = 'flex items-center mb-3 px-5 py-3 bg-transparent text-light dark:text-white/60 font-normal [&.active]:text-primary [&.active]:bg-primary/10 duration-300 gap-[12px] cursor-pointer';
  ...
  networkList = [
        ...
        },
        {
            ...
            icon: 'instagram',
            avatarColor: '#fff',
            avatarBg: 'linear-gradient(135deg, #405DE6, #5851DB, #833AB4)',
            status: false,
    ...
    ngOnInit(): void {
        // Simulate loading time
         ...
         // code to get user information to display on profile information.
